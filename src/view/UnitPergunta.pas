...
type
  ...
  public
    ...
    class function Pergunta(aTexto : String; aTipoMensagem: TTipoMensagem): boolean;
  end;
...
class function TfrmPergunta.Pergunta(aTexto: String; aTipoMensagem: TTipoMensagem): boolean;
begin
