...
type
  ...
  public
    ...
    class function ExibirMensagem(aMsg: string; aTipoMensagem: TTipoMensagem):boolean;
...
class function TFrmMensagem.ExibirMensagem(aMsg: string; aTipoMensagem: TTipoMensagem): boolean;
